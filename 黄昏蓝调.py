...
# 定义颜色
PRIMARY_COLOR = "#A9C3C2"  # 主色调，柔和的蓝绿色
SECONDARY_COLOR = "#ECD5A4"  # 次级色调，淡黄色
ACCENT_COLOR = "#F5EABD"  # 强调色，浅米色
HIGHLIGHT_COLOR = "#ECD273"  # 高亮色，金黄色
DARKER_ACCENT_COLOR = "#D5B53B"  # 较深的强调色，深金色
TEXT_COLOR = "#2E4A62"  # 偏蓝的深灰色，确保文本可读性

Canvas = {
    "bg": ACCENT_COLOR,  # 使用柔和的米色作为背景
    "insertbackground": PRIMARY_COLOR,  # 使用主色调作为插入背景
    "highlightthickness": 0,
}

Frame = {
    "bg": SECONDARY_COLOR,  # 使用次级色调作为背景
